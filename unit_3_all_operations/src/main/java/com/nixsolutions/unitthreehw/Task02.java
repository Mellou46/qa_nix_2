...
public class Task02 {
    ...
    public void run() {
        ...
        System.out.println( "Рализуйте задачу, которая принимает строку с консоли и вычленяет все символы латиницы/кириллицы и сортирует их, указывая количество вхождений каждого символа. Пример: Входные данные: 1w4tt!7 Выходные данные: 1. t - 2; 2. w - 1");
        System.out.println("Введите вашу сроку: ");
